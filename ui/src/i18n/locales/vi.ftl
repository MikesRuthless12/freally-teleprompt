...
import-not-itemised = Không thể liệt kê nội dung của một tệp PDF - hãy đối chiếu văn bản với bản gốc.
...
## Phím tắt, bàn đạp chân và phím tắt toàn hệ thống (FT-M04 / FT-M13 / FT-M16)
shortcuts-title = Phím tắt và bàn đạp
shortcuts-intro = Bấm vào một gán phím để thay đổi, rồi nhấn phím, nút điều khiển từ xa hoặc bàn đạp bạn muốn. Phím tắt «Trong ứng dụng» hoạt động khi Freally Teleprompt đang ở phía trước; loại «Mọi nơi» hoạt động dù bạn đang ở đâu.
shortcuts-search = Tìm lệnh và phím
shortcuts-command = Lệnh
shortcuts-in-app = Trong ứng dụng
shortcuts-global = Mọi nơi
shortcuts-window-only = Chỉ trong ứng dụng
shortcuts-no-matches = Không có lệnh nào khớp.
shortcuts-listening = Nhấn một phím cho { $command }, hoặc Esc để hủy
shortcuts-listening-short = Nhấn một phím…
shortcuts-rebind = Đổi gán phím cho { $command }
shortcuts-clear = Xóa gán phím cho { $command }
shortcuts-conflict = Cũng được gán cho { $others }
shortcuts-not-registered = Một chương trình khác đang dùng phím này ({ $reason })
shortcuts-wayland = Wayland không cho phép ứng dụng giữ phím ở mức toàn hệ thống, nên các gán phím «Mọi nơi» có thể không hoạt động trong phiên này.
shortcuts-reset = Khôi phục mặc định
shortcuts-cancel = Hủy
shortcuts-apply = Áp dụng
cmd-play-pause = Phát / tạm dừng
cmd-stop = Dừng
cmd-top = Về đầu
cmd-faster = Nhanh hơn
cmd-slower = Chậm hơn
cmd-step-back = Lùi một bước
cmd-step-forward = Tiến một bước
cmd-next-marker = Phần tiếp theo
cmd-prev-marker = Phần trước
cmd-find = Tìm và thay thế
