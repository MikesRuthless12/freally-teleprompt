...
import-not-itemised = لا يمكن سرد محتويات ملف PDF - قارن النص بالأصل.
...
## الاختصارات ودواسات القدم والاختصارات على مستوى النظام (FT-M04 / FT-M13 / FT-M16)
shortcuts-title = الاختصارات والدواسات
shortcuts-intro = اضغط على أي تعيين لتغييره، ثم اضغط المفتاح أو زر جهاز التحكم أو الدواسة التي تريدها. تعمل اختصارات «داخل التطبيق» ما دام Freally Teleprompt في المقدمة، أما اختصارات «في أي مكان» فتعمل أينما كنت.
shortcuts-search = ابحث في الأوامر والمفاتيح
shortcuts-command = الأمر
shortcuts-in-app = داخل التطبيق
shortcuts-global = في أي مكان
shortcuts-window-only = داخل التطبيق فقط
shortcuts-no-matches = لا توجد أوامر مطابقة.
shortcuts-listening = اضغط مفتاحًا لـ { $command }، أو Esc للإلغاء
shortcuts-listening-short = اضغط مفتاحًا…
shortcuts-rebind = تغيير تعيين { $command }
shortcuts-clear = مسح تعيين { $command }
shortcuts-conflict = معيَّن أيضًا لـ { $others }
shortcuts-not-registered = يستخدم برنامج آخر هذا المفتاح ({ $reason })
shortcuts-wayland = لا يسمح Wayland للتطبيقات بحجز المفاتيح على مستوى النظام، لذا قد لا تعمل تعيينات «في أي مكان» في هذه الجلسة.
shortcuts-reset = استعادة الإعدادات الافتراضية
shortcuts-cancel = إلغاء
shortcuts-apply = تطبيق
cmd-play-pause = تشغيل / إيقاف مؤقت
cmd-stop = إيقاف
cmd-top = العودة إلى البداية
cmd-faster = أسرع
cmd-slower = أبطأ
cmd-step-back = خطوة إلى الخلف
cmd-step-forward = خطوة إلى الأمام
cmd-next-marker = القسم التالي
cmd-prev-marker = القسم السابق
cmd-find = بحث واستبدال
