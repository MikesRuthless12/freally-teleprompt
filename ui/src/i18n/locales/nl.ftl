...
import-not-itemised = De inhoud van een PDF kan niet worden opgesomd - vergelijk de tekst met het origineel.
...
## Sneltoetsen, voetpedalen en systeembrede sneltoetsen (FT-M04 / FT-M13 / FT-M16)
shortcuts-title = Sneltoetsen en voetpedalen
shortcuts-intro = Klik op een toewijzing om die te wijzigen en druk daarna op de toets, afstandsbediening of pedaalknop die u wilt. Sneltoetsen onder „In de app” werken zolang Freally Teleprompt op de voorgrond staat; die onder „Overal” werken waar u ook bezig bent.
shortcuts-search = Zoek opdrachten en toetsen
shortcuts-command = Opdracht
shortcuts-in-app = In de app
shortcuts-global = Overal
shortcuts-window-only = Alleen in de app
shortcuts-no-matches = Geen opdrachten gevonden.
shortcuts-listening = Druk op een toets voor { $command }, of op Esc om te annuleren
shortcuts-listening-short = Druk op een toets…
shortcuts-rebind = Toewijzing van { $command } wijzigen
shortcuts-clear = Toewijzing van { $command } wissen
shortcuts-conflict = Ook toegewezen aan { $others }
shortcuts-not-registered = Een ander programma gebruikt deze toets ({ $reason })
shortcuts-wayland = Wayland laat toepassingen geen toetsen systeembreed opeisen, dus „Overal”-toewijzingen werken in deze sessie mogelijk niet.
shortcuts-reset = Standaardwaarden herstellen
shortcuts-cancel = Annuleren
shortcuts-apply = Toepassen
cmd-play-pause = Afspelen / pauzeren
cmd-stop = Stoppen
cmd-top = Terug naar het begin
cmd-faster = Sneller
cmd-slower = Langzamer
cmd-step-back = Stap terug
cmd-step-forward = Stap vooruit
cmd-next-marker = Volgend onderdeel
cmd-prev-marker = Vorig onderdeel
cmd-find = Zoeken en vervangen
